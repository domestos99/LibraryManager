...
namespace Microsoft.Web.LibraryManager.Test.Providers.json
{
    ...
    public class JsonProviderTest
    {
        ...
        public void Setup()
        {
            ...
            _dependencies = new Dependencies(hostInteraction, new JsonProviderFactory());
        ...
        {
            IProvider provider = _dependencies.GetProvider("json");
  ...
  ""{ManifestConstants.Libraries}"": [
    {{
      ""{ManifestConstants.Provider}"": ""json"",
